...
export interface ApiAgencyAgency extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    subscription_status: Schema.Attribute.Enumeration<['Active', 'Inactive']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    >;
    wallet_balance: Schema.Attribute.Integer;
  };
}

export interface ApiAgentSubscriptionAgentSubscription
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    payment_id: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    selected_position: Schema.Attribute.Integer;
    selected_product: Schema.Attribute.Relation<
      'oneToOne',
      'api::product.product'
    >;
...
export interface ApiBookingFormBookingForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    arrival: Schema.Attribute.DateTime & Schema.Attribute.Required;
    booking_date: Schema.Attribute.DateTime;
    booking_expiry: Schema.Attribute.DateTime;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departure: Schema.Attribute.DateTime & Schema.Attribute.Required;
    description: Schema.Attribute.String;
    email: Schema.Attribute.String & Schema.Attribute.Required;
    guest: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::city.city'> &
      Schema.Attribute.Private;
    metro_stations: Schema.Attribute.Relation<
      'oneToMany',
      'api::metro-station.metro-station'
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiMetroStationMetroStation
  extends Struct.CollectionTypeSchema {
...
export interface ApiNotificationNotification
  ...
  attributes: {
    booking_form: Schema.Attribute.Relation<
      'oneToOne',
      'api::booking-form.booking-form'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    notification_status: Schema.Attribute.Enumeration<['Active', 'Read']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    agent_subscription: Schema.Attribute.Relation<
      'oneToOne',
      'api::agent-subscription.agent-subscription'
    >;
    ...
    infrastructures: Schema.Attribute.Relation<
      'manyToMany',
      'api::infrastructure.infrastructure'
    >;
    is_booked: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    kitchens: Schema.Attribute.Relation<'manyToMany', 'api::kitchen.kitchen'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    ...
    metro_station: Schema.Attribute.Relation<
      'oneToOne',
      'api::metro-station.metro-station'
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    agent_subscriptions: Schema.Attribute.Relation<
      'oneToMany',
      'api::agent-subscription.agent-subscription'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::agent-subscription.agent-subscription': ApiAgentSubscriptionAgentSubscription;
